...
class Doctor():
    ...
    def save_appointment(self):
        ...
        while we:
            request_date = input()
            request = datetime.datetime.strptime(request_date,'%d.%m.%Y').date()    #change to another date format

            chosen_weekday = calendar.day_name[request.weekday()]   #save the weekday
