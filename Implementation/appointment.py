...
class Appointment:
    ...
    def __init__(self, patient_name, date, app_time):
...
appointment = ['patient_name', 'date', app_time] #so richtig? app_time? Es soll ja immer nur eine Uhrzeit / ein Element gespeichert werden
